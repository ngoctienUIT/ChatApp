...
//     var friendItemController = FriendItemControllers.inst.get(widget.friendId);
...
//           },
//         ),
//         title: _FriendTitle(friendItemController),
//         actions: [const _CallButton(), const _VideoCallButton(), Obx(()=>_FriendOptionButton(friendItemController.userData['name']))],
//       ),
//       body: WillPopScope(
//         onWillPop: () {
//           if (isKeyboardShow) {
//             setState(() => isKeyboardShow = false);
//           } else {
...
//               child: SizedBox(
//                 height: isKeyboardShow ? MediaQuery.of(context).size.height * 0.4 : 70,
//                 child: Column(
...
//                               onTap: () {
//                                 if (isKeyboardShow) {
//                                   setState(() => isKeyboardShow = !isKeyboardShow);
//                                 }
//                               },
//                               onChanged: (value) {
//                                 if (value.isNotEmpty) {
...
//                                   icon: Icon(
//                                     isKeyboardShow ? Icons.keyboard : Icons.emoji_emotions_outlined,
//                                   ),
//                                   onPressed: () {
//                                     if (!isKeyboardShow) {
//                                       _focusNode.unfocus();
...
//                     ),
//                     Expanded(
//                       flex: isKeyboardShow ? 1 : 0,
//                       child: isKeyboardShow ? emojiSelect() : Container(),
//                     )
//                   ],
//                 ),
//               ),
